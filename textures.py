...
BAT_ANIM: Final[arcade.TextureAnimation] = _load_animation_strip(asset_path("assets/Top_Down_Adventure_Pack_v.1.0/Enemies_Sprites/Pinkbat_Sprites/pinkbat_idle_left_anim_strip_5.png"), frame_count=5)
